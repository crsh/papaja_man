...
results in: Participants mean age was `r printnum(age_mean)` years (*SD* = `r printnum(age_sd)`).
...
`apa_print()` currently supports a variety of output objects from differ
