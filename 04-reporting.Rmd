...
knitr::kable(
  print_classes
  , caption = "Object classes supported by apa_print()."
)
```
...
If possible, avoid caching `library()` calls. Subsequent use of functions from these packages in non-cached chunks will throw errors
