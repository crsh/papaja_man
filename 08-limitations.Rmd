...
```{r vertical-spacing, fig.cap = "An example of large vertical spacing between paragraphs and section headings in a rendered PDF document.", echo = FALSE, fig.align = "center"}
