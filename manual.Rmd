...
### Handling time consuming computations
-->

# papaja
## Goals and concept
- As little computation as possible
- Primarily text formatting
- PDF and Word
- Alternatives
  - papeR
  - rticles
...
## General procedure
- S3 methods
- Standard output / S3-method definition
  - est, stat, full, table, etc.
...
## Publishing reproducible manuscripts
