...
They are intended to provide a most convenient way to obtain a publication-ready figure with only the most necessary arguments
while maintaining enough flexibility for a lot of costomizing.
...
while the other argments represent chracter strings identifying the columns that contain the a sibject identifier `id`, the dependendent variable `dv`, and the between- or within-subjects `factors`.
-->



They are build around the `graphics` packages that is part of the base distribution of R.
