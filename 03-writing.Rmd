...
```{r bee, fig.cap = "Bee plot of the example data set. Small points represent individual observations, large points represent means, and error bars represent 95% within-subjects confidence intervals. \\label{fig:bee}", echo = TRUE, dev.args = list(bg = 'white'), fig.width = 8}
apa_beeplot(
  mixed_data
  , id = "Subject"
  , dv = "Recall"
...
A little candy: You can also require within-subjects confidence intervals as described by @morey (as we already did in \autoref{fig:bee}).
...
- The names of depent variable, factors and factor levels; a legend, if necessary.
