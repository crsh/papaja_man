...
`papaja` provides the functions `apa_beeplot`, `apa_lineplot`, and `apa_barplot` to easily plot data from factorial designs (`apa_factorial_plot` is the underlying workhorse function).
