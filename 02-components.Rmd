...
For convenience, you can generate the YAML-code for the author-metadata with most of the above-mentioned information using the web application [*tenzing*](https://martonbalazskovacs.shinyapps.io/tenzing/) [@holcombe_tenzing_2020].
Simply collect the metadata in an Excel or GoogleSheet, upload it to the web application and copy the generated YAML into the front-matter of your document.
```
