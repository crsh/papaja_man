...
Including R code inline is a convenient way of including the contents of variables as part of the text.
...
Reporting numerical values will frequently require some rounding and/or filling with trailing zeros (e.g., "$24.10$").
In chapter \@ref(reporting), we introduce papaja functions that are helpful in formatting a multitude of data types
(e.g. simple numerics, outputs from statistical tests or models, etc.).
