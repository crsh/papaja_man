...
For convenience, you can generate the YAML-code for the author-metadata with all of the above-mentioned information using the web application [*tenzing*](https://martonbalazskovacs.shinyapps.io/tenzing/) [@holcombe_tenzing_2020].
